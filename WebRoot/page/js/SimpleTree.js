function openNewWindow(temp){
	window.open('getTableCol.do?schema='+schema+'&table='+temp+'','_blank','left=280,top=130,height=800,width=1200,menubar=no,toolbar=no,location=no,status=no,scrollbars=yes');
}
