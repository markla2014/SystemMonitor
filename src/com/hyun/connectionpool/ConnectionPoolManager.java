...
import com.hyun.common.DateTimeUtil;
...
public class ConnectionPoolManager implements ConnectionPool {
    ...
    private List<TimedConnection> leasedConnections = new ArrayList<TimedConnection>();
     private int minimumActiveConnections;
     private static final String driverClassName="com.cloudwave.jdbc.CloudDriver";
     private String url;
	...
	public void setMinimumActiveConnections(int minimumActiveConnections) {
		this.minimumActiveConnections = minimumActiveConnections;
	}
    ...
    */ 
	...
	// to the list of available connections in the connection pool
        for(int i = 0; i < minimumActiveConnections; i++) {
	...
	if (getNumberOfAvailableConnections() == minimumActiveConnections && minimumActiveConnections > 0) {
    ...
    */ 
    private TimedConnection createConnectionForPool() {
	    ...
	    // Create the database connection and catch the exception if a database access error occurs
            CloudConnection connection = (CloudConnection) DriverManager.getConnection(
    ...
    */ 
	...
	// connections (the total from the available connections list and used connections list) is 
        ...
        if ((availableConnections.size() + leasedConnections.size()) < maximumActiveConnections) {
            return false;
        }
    ...
    * @throws SQLException
    */  
    public synchronized CloudConnection getConnection() throws SQLException {
