...
public class QueryDao extends BaseDao {
    ...
    public String[] checkTableName(Connection connection, String schema) throws GwtException {
        try {
            CloudDatabaseMetaData meta = (CloudDatabaseMetaData) connection.getMetaData();
            CloudResultSet result = (CloudResultSet) meta.getTables("default", schema, null, new String[] { "TABLE" });
    ...
    public String[][] getViewList(Connection connection, String schema) throws GwtException {
        try {
            CloudDatabaseMetaData meta = (CloudDatabaseMetaData) connection.getMetaData();
    ...
    public String[][] getViewDefinition(CloudConnection connection, String schema, String table) throws GwtException {
        ArrayList<String[]> rows = new ArrayList<String[]>();
        try {
            DatabaseMetaData meta = connection.getMetaData();
            CloudResultSet crs = (CloudResultSet) meta.getTables(null, schema, table, new String[] { "VIEW" });
    ...
    public String[][] getTableDistributionRecord(CloudConnection connection, String schema, String table, int pagenum) throws Exception {
    ...
    public String[][] getTableDistribution(CloudConnection connection, String schema, String table) throws GwtException {
        ArrayList<String[]> array = new ArrayList<String[]>();
        try {
